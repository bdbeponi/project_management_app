...
class ClientDetailsResponseModel {
    ...
    ClientDetailsResponseModel copyWith({
        int? statusCode,
        Data? data,
        String? message,
        bool? success,
    ...
    factory ClientDetailsResponseModel.fromRawJson(String str) => ClientDetailsResponseModel.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory ClientDetailsResponseModel.fromJson(Map<String, dynamic> json) => ClientDetailsResponseModel(
